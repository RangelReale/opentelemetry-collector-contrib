...
func fillTestValueAtQuantileSlice(tv pmetric.SummaryDataPointValueAtQuantileSlice, values []float64) {
...
func fillTestValueAtQuantile(tv pmetric.SummaryDataPointValueAtQuantile, v float64) {
	tv.SetQuantile(v)
	tv.SetValue(v)
}
